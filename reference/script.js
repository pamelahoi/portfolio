...
function openProject(projectKey) {
  ...
  projectContents.forEach((content) => { content.hidden = true; });
  windowElement.classList.toggle("is-video-case", Boolean(project.video));
  windowElement.classList.toggle("is-figma-case", isCustomCase && !project.video);
